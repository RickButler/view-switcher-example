...
new Moonboots({
    moonboots: {
        jsFileName: 'view-switcher-example',
        cssFileName: 'view-switcher-example',
...
console.log('view-switcher-example is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
